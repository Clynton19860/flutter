...
class CaptureScreen extends StatefulWidget{
  ...
  @override
  State<StatefulWidget> createState() => _CaptureScreenState();
}
...
class _CaptureScreenState extends State<CaptureScreen>{
  ...
  void _calculate(){
    ...
    setState(() => _premium = calculatePremium(request));
  }
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    child: Column(
      children: [
        SegmentedButton(segments: [for(final c in Cover.values) ButtonSegment(value: c, label: Text(c.name)
        )], selected: {_cover},
